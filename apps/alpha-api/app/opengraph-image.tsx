...
export const alt = "PharosPay Alpha API";
    ...
    (
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          ...
          <div style={{ fontSize: "34px", fontWeight: 700 }}>PharosPay Alpha</div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ fontSize: "28px", color: "rgba(255,255,255,.85)" }}>
            Pay per call over x402, settled on Pharos. 0.01 pUSD per request.
          </div>
        </div>
      </div>
    ),
